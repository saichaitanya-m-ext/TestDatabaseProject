...
namespace MEDSEEK.Navigate.Database.Context
{
    ...
    public partial class ufn_HEDIS_GetPatients_EncouterClaims_ByRevenue_SelectedPopulation_MP_Result
    {
        public Nullable<int> PatientID { get; set; }
        public Nullable<int> ClaimInfoId { get; set; }
        public string ClaimNumber { get; set; }
        public Nullable<int> EDIClaimTypeID { get; set; }
        ...
        public Nullable<System.DateTime> IncurredDate { get; set; }
        public Nullable<System.DateTime> ClaimProcessedDate { get; set; }
        ...
        public Nullable<int> ClaimCreatedByUserID { get; set; }
        ...
        public Nullable<int> ClaimLineRecordTag_FileID { get; set; }
