CREATE PROCEDURE [dbo].[usp_HEDIS_HealthPlans_CDC_GetPatients_EncouterClaims_2012]
(
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS_HealthPlans_CDC_GetPatients_EncouterClaims_2012] TO [FE_rohit.r-ext]
    AS [dbo];
