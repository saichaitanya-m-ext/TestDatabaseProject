CREATE PROCEDURE [dbo].[usp_HEDIS-L_HealthPlans_ART_GetDenominator_2012]
(
...
EXEC dbo.usp_HEDIS_HealthPlans_ART_GetPatients_EncouterClaims_2012 @AnchorDate_Year, @AnchorDate_Month, @AnchorDate_Day,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS-L_HealthPlans_ART_GetDenominator_2012] TO [FE_rohit.r-ext]
    AS [dbo];
