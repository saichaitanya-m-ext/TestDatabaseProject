/*    
------------------------------------------------------------------------------    
Procedure Name: usp_DocumentType_Delete    
Description   : This procedure is used to delete record from document type table
Created By    : Pramod    
...
------------------------------------------------------------------------------    
*/  
CREATE PROCEDURE [dbo].[usp_DocumentType_Delete]  
(  
	@i_AppUserId INT,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_DocumentType_Delete] TO [FE_rohit.r-ext]
    AS [dbo];
