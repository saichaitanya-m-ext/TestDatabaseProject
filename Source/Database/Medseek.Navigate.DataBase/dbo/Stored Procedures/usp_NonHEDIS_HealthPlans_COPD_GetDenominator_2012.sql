...
CREATE PROCEDURE [dbo].[usp_NonHEDIS_HealthPlans_COPD_GetDenominator_2012] (  
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_NonHEDIS_HealthPlans_COPD_GetDenominator_2012] TO [FE_rohit.r-ext]
    AS [dbo];
