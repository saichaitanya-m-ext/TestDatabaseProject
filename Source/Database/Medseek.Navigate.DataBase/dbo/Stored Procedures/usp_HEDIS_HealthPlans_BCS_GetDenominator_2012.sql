CREATE PROCEDURE [dbo].[usp_HEDIS_HealthPlans_BCS_GetDenominator_2012]
(
...
CREATE TABLE #BCS_Insureds_Eligible_CurrentYear
(
...
CREATE TABLE #BCS_Insureds_Eligible_PriorYear
(
	[PatientID] int PRIMARY KEY CLUSTERED
)
...
INSERT INTO #BCS_Insureds_Eligible_CurrentYear
...
/* Retrieves the 'Patient IDs' of Patients in the Eligible Population of Insureds from Prior Year, and store the 'Patient IDs'
   in the created Temporary table. */
INSERT INTO #BCS_Insureds_Eligible_PriorYear
EXEC dbo.usp_HEDIS_HealthPlans_GetInsureds_2012 @InsuranceProductTypes, @InsurancePlanTypes, @InsuranceBenefitTypes,
												@AnchorDate_Year , @AnchorDate_Month, @AnchorDate_Day, @IsPrimary,
												@NumMonths_Prior_Insured_Commercial, @NumMonths_After_Insured_Commercial,
												@NumMonths_Prior_Insured_Medicare, @NumMonths_After_Insured_Medicare,
...
(
 ...
 (
  ...
  SELECT [PatientID]
  FROM #BCS_Insureds_Eligible_CurrentYear
  ...
  SELECT [PatientID]
  FROM #BCS_Insureds_Eligible_PriorYear
 )
...
DROP TABLE #BCS_Insureds_Eligible_CurrentYear;
DROP TABLE #BCS_Insureds_Eligible_PriorYear;

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS_HealthPlans_BCS_GetDenominator_2012] TO [FE_rohit.r-ext]
    AS [dbo];
