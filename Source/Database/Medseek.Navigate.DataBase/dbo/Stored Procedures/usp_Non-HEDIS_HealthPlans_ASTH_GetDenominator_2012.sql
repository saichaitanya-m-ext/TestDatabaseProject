...
CREATE PROCEDURE [dbo].[usp_Non-HEDIS_HealthPlans_ASTH_GetDenominator_2012]  
(  
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_Non-HEDIS_HealthPlans_ASTH_GetDenominator_2012] TO [FE_rohit.r-ext]
    AS [dbo];
