CREATE PROCEDURE [dbo].[usp_HEDIS_HealthPlans_COL_GetDenominator_2012] (
...
CREATE TABLE #COL_Insureds_Eligible_CurrentYear ([PatientID] INT PRIMARY KEY CLUSTERED)

/* Temporary Table to store 'Patient IDs' of Patients in the Eligible Population of Insureds. */
CREATE TABLE #COL_Insureds_Eligible_PriorYear ([PatientID] INT PRIMARY KEY CLUSTERED)
...
INSERT INTO #COL_Insureds_Eligible_CurrentYear
...
INSERT INTO #COL_Insureds_Eligible_PriorYear
EXEC dbo.usp_HEDIS_HealthPlans_GetInsureds_2012 @InsuranceProductTypes
	,@InsurancePlanTypes
	,@InsuranceBenefitTypes
	,@AnchorDate_Year
...
FROM (
	...
	@Num_Months_After_EligiblePop, @EligibleAge_MIN, @EligibleAge_MAX,  @IsDeceased,@PatientStatus)
...
DROP TABLE #COL_Insureds_Eligible_CurrentYear;

DROP TABLE #COL_Insureds_Eligible_PriorYear;

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS_HealthPlans_COL_GetDenominator_2012] TO [FE_rohit.r-ext]
    AS [dbo];
