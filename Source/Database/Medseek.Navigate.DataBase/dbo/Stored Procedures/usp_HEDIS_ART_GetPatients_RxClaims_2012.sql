CREATE PROCEDURE [dbo].[usp_HEDIS_ART_GetPatients_RxClaims_2012]
(
 @AnchorDate_Year int ,
...
INSERT INTO
    ...
    SELECT
        ...
        pat.[DateFilled]
    FROM
        dbo.ufn_HEDIS_CDC_GetPatients_RxClaims(@AnchorDate_Year , @AnchordDate_Month , @AnchordDate_Day , @Num_Years_Prior , @Num_Years_After , @ECTCodeStatus , @ECTCodeVersion_Year) AS pat
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS_ART_GetPatients_RxClaims_2012] TO [FE_rohit.r-ext]
    AS [dbo];
