CREATE PROCEDURE [dbo].[usp_HEDIS_HealthPlans_ASTH_GetPatients_RxClaims_2012]
(
...
(
 ...
 FROM dbo.ufn_HEDIS_GetPatients_RxClaims('ASM-C', @AnchorDate_Year, @AnchorDate_Month, @AnchorDate_Day, @Num_Months_Prior,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS_HealthPlans_ASTH_GetPatients_RxClaims_2012] TO [FE_rohit.r-ext]
    AS [dbo];
