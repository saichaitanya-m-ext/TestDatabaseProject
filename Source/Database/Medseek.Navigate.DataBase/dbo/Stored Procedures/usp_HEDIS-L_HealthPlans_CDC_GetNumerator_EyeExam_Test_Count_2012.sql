CREATE PROCEDURE [dbo].[usp_HEDIS-L_HealthPlans_CDC_GetNumerator_EyeExam_Test_Count_2012] (
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS-L_HealthPlans_CDC_GetNumerator_EyeExam_Test_Count_2012] TO [FE_rohit.r-ext]
    AS [dbo];
