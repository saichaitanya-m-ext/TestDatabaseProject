CREATE PROCEDURE [dbo].[usp_HEDIS_HealthPlans_CDC_GetDenominator_2012] (
...
CREATE TABLE #CDC_Insureds_Eligible ([PatientID] INT PRIMARY KEY CLUSTERED)
...
CREATE TABLE #CDC_Encounters_Eligible ([PatientID] INT PRIMARY KEY CLUSTERED)

/* Temporary Table to store 'Patient IDs' of Patients in the Eligible Population of Patients with required
   number of Pharmacy/Rx Claims during the Measurement Period. */
CREATE TABLE #CDC_Rx_Eligible ([PatientID] INT PRIMARY KEY CLUSTERED)
...
INSERT INTO #CDC_Insureds_Eligible
...
INSERT INTO #CDC_Encounters_Eligible
EXEC dbo.usp_HEDIS_HealthPlans_CDC_GetPatients_EncounterClaims_2012 @AnchorDate_Year
	,@AnchorDate_Month
	,@AnchorDate_Day
...
/* Retrieves the 'Patient IDs' of Patients in the Eligible Population of Patients with required number
   ...
   table. */
INSERT INTO #CDC_Rx_Eligible
EXEC dbo.usp_HEDIS_HealthPlans_CDC_GetPatients_RxClaims_2012 @AnchorDate_Year
	,@AnchorDate_Month
	,@AnchorDate_Day
	,@Num_Months_Prior_Rx
	,@Num_Months_After_Rx
...
DROP TABLE #CDC_Insureds_Eligible;

DROP TABLE #CDC_Encounters_Eligible;

DROP TABLE #CDC_Rx_Eligible;

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS_HealthPlans_CDC_GetDenominator_2012] TO [FE_rohit.r-ext]
    AS [dbo];
