CREATE PROCEDURE [dbo].[usp_HEDIS-L_HealthPlans_CDC_GetPatients_EncounterClaims_2012]
(
...
CREATE TABLE [#ECTCodes_CDC_L_Table_C]
(
...
CREATE NONCLUSTERED INDEX [IDX_ECTCodes_CDC_L_Table_C] ON #ECTCodes_CDC_L_Table_C
(
	[ECTCode] ASC,
...
CREATE TABLE #CDC_L_Candidate_Patients
(
...
CREATE CLUSTERED INDEX [IDX_CDC_L_Candidate_Patients] ON #CDC_L_Candidate_Patients
(
	[PatientID] ASC,
	[ClaimInfoID] ASC,
	[ClaimLineID] ASC,
...
INSERT INTO #ECTCodes_CDC_L_Table_C
...
INSERT INTO #CDC_L_Candidate_Patients
...
(
	...
	FROM #CDC_L_Candidate_Patients
	WHERE [ProcedureCode] IN (SELECT [ECTCode]
							  FROM #ECTCodes_CDC_L_Table_C
...
DROP TABLE #ECTCodes_CDC_L_Table_C;
DROP TABLE #CDC_L_Candidate_Patients;

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS-L_HealthPlans_CDC_GetPatients_EncounterClaims_2012] TO [FE_rohit.r-ext]
    AS [dbo];
