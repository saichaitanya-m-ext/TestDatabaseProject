CREATE PROCEDURE [dbo].[usp_HEDIS_ART_GetInsureds_EnrollmentGaps_Eligible_2012]
(
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS_ART_GetInsureds_EnrollmentGaps_Eligible_2012] TO [FE_rohit.r-ext]
    AS [dbo];
