CREATE PROCEDURE [dbo].[usp_HEDIS-L_HealthPlans_CDC_GetPatients_RxClaims_2012]
(
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS-L_HealthPlans_CDC_GetPatients_RxClaims_2012] TO [FE_rohit.r-ext]
    AS [dbo];
