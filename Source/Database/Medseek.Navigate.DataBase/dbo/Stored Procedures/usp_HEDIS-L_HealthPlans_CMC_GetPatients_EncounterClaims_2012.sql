CREATE PROCEDURE [dbo].[usp_HEDIS-L_HealthPlans_CMC_GetPatients_EncounterClaims_2012]
(
...
CREATE TABLE [#ECTCodes_CMC_L_Table_A]
(
...
CREATE NONCLUSTERED INDEX [IDX_ECTCodes_CMC_L_Table_A] ON #ECTCodes_CMC_L_Table_A
(
	[ECTCode] ASC,
...
CREATE TABLE [#ECTCodes_CMC_L_Table_C]
(
	[ECTCode] varchar(20) NOT NULL,
	[ECTCodeDescription] varchar(255) NOT NULL,
	[ECTHedisCodeTypeCode] varchar(20) NOT NULL
...
CREATE NONCLUSTERED INDEX [IDX_ECTCodes_CMC_L_Table_C] ON #ECTCodes_CMC_L_Table_C
(
	[ECTCode] ASC,
	[ECTCodeDescription] ASC,
	[ECTHedisCodeTypeCode] ASC
...
CREATE TABLE #CMC_L_Candidate_EventsPatients
(
...
CREATE CLUSTERED INDEX [IDX_CMC_L_Candidate_EventsPatients] ON #CMC_L_Candidate_EventsPatients
(
	[PatientID] ASC,
	[ClaimInfoID] ASC,
	[ClaimLineID] ASC,
...
CREATE TABLE #CMC_L_Candidate_DiagnosesPatients
(
	[PatientID] int NOT NULL,
	[ClaimInfoID] int NOT NULL,
	[ClaimLineID] int NULL,
...
CREATE CLUSTERED INDEX [IDX_CMC_L_Candidate_DiagnosesPatients] ON #CMC_L_Candidate_DiagnosesPatients
(
	[PatientID] ASC,
	[ClaimInfoID] ASC,
	[ClaimLineID] ASC,
...
INSERT INTO #ECTCodes_CMC_L_Table_A
...
INSERT INTO #CMC_L_Candidate_EventsPatients
...
FROM dbo.ufn_HEDIS_GetPatients_EncouterClaims('CMC-A', (@AnchorDate_Year - 1), (@AnchorDate_Month - 1), (@AnchorDate_Day - 30),
...
INSERT INTO #ECTCodes_CMC_L_Table_C
SELECT [ECTCode], [ECTCodeDescription], [ECTHedisCodeTypeCode]
...
INSERT INTO #CMC_L_Candidate_DiagnosesPatients
...
FROM #CMC_L_Candidate_EventsPatients
WHERE ([ProcedureCode] IN (SELECT [ECTCode]
						   FROM #ECTCodes_CMC_L_Table_A
	...
	(
	  ...
	  FROM (
			...
			FROM (
				  ...
				  FROM #CMC_L_Candidate_DiagnosesPatients
...
DROP TABLE #ECTCodes_CMC_L_Table_A;
DROP TABLE #ECTCodes_CMC_L_Table_C;
DROP TABLE #CMC_L_Candidate_EventsPatients;
DROP TABLE #CMC_L_Candidate_DiagnosesPatients;

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[usp_HEDIS-L_HealthPlans_CMC_GetPatients_EncounterClaims_2012] TO [FE_rohit.r-ext]
    AS [dbo];
