CREATE FUNCTION [dbo].[ufn_HEDIS_GetPatients_EncouterClaims_ByProcedure_SelectedPopulation_SpecialtyContionEyeExam] 
(
...
BEGIN
  ...
  *********************************************************************************************************************************************/
		...
		INNER JOIN [dbo].[PopulationDefinitionPatients] p WITH(NOLOCK)
			ON p.[PatientID] = ci.[PatientID]
