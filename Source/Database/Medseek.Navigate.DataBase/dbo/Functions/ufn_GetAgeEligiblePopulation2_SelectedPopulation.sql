...
CREATE FUNCTION [dbo].[ufn_GetAgeEligiblePopulation2_SelectedPopulation]
(
...
(
	...
	SELECT p.[PatientID], pat.[AccountStatusCode] AS 'PatientStatus', pat.[UserID], u.[UserLoginName],
		   ...
		   csre.RelationCode AS [PrimaryAddressContactRelationshipToPatient],
		   lkat.[AddressTypeCode] AS [PrimaryAddressType], pat.[PrimaryAddressLine1],
		   ...
		   pat.[SecondaryAddressContactName], csrs.RelationCode AS [SecondaryAddressContactRelationshipToPatient], lkt.[AddressTypeCode] AS [SecondaryAddressType], pat.[SecondaryAddressLine1], pat.[SecondaryAddressLine2],
		   pat.[SecondaryAddressLine3], pat.[SecondaryAddressCity], css.[StateCode] AS [SecondaryAddressStateCode], cscs.[CountryName] AS [SecondaryAddressCounty], pat.[SecondaryAddressPostalCode], cscs.[CountryCode] AS [SecondaryAddressCountryCode],
